...
function KanbanBoard() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') { // Check if we are in the browser environment
            const overlay = document.createElement('div');
            document.body.appendChild(overlay);
            overlayRef.current = overlay;
            setIsOverlayReady(true); // Set the state to true after the overlay is ready
        }
    ...
    return (
        <>
            <div className="header-container w-full flex ml-24 justify-between">
                <button
                    onClick={() => {
                        createNewColumn();
                    }}
            ...
            <div className="-mb-40">
                <form>
                    <div className="max-w-7xl mx-auto mb-4 mt-5 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                            ...
                            <textarea id="editor" rows={8} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required />
                        </div>
                    </div>
                </form>
                <button type="submit" className=" ml-28 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                    Save Notes
                </button>
            </div>
        ...
        px-[40px]">
                ...
                >
                    ...
                    {isOverlayReady && overlayRef.current && createPortal(
                        <DragOverlay>
                            {activeColumn && (
                                <ColumnContainer
                                    column={activeColumn}
