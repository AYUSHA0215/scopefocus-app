...
export function CustomProfilePage() {
  return (
    <main className="p-4 md:p-10 mx-auto max-w-7xl">
      ...
      <div className="mb-6 mt-6">
        <label htmlFor="large-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Goals</label>
        <input type="text" id="large-input" className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
      </div>
      <div className="mb-6 mt-6">
      ...
      <form className="max-w-sm mx-auto">
        <label htmlFor="number-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Career length (So Far) </label>
        <input type="number" id="number-input" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90210" required />
      </form>
      <form className="max-w-sm mx-auto">
        <label htmlFor="phone-input" className="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">Phone number:</label>
      ...
      <form className="max-w-sm mx-auto">
        <label htmlFor="countries" className="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
      ...
      <label htmlFor="message" className="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">Project Interests</label>
      <textarea id="message" rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
      <div className="flex items-center mt-6 mb-4">
        <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
        <label htmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Personality question option 1</label>
      </div>
      <div className="flex items-center">
        ...
        <label htmlFor="checked-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Personality question option 2</label>
      </div>
      <h3 className="mb-4 mt-6 font-semibold text-gray-900 dark:text-white">Tech Stack</h3>
      ...
      <h3 className="mb-5 mt-6 text-lg font-medium text-gray-900 dark:text-white">Choose technology:</h3>
        ...
        <li>
          ...
          <label htmlFor="react-option" className="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="block">
              ...
              <div className="w-full text-sm">A JavaScript library htmlFor building user interfaces.</div>
            </div>
          </label>
        </li>
        <li>
      ...
      <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700 mt-7">
        ...
        <label htmlFor="bordered-radio-1" className="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fun personality q2 option 1</label>
      </div>
